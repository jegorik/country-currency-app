    ...
    with st.sidebar:
        ...
        if not st.session_state.authenticated:
            ...
            with st.sidebar.form("databricks_connection_form"):
                # Get default values from terraform.tfvars or environment variables
                default_host = config_values.get('databricks_host') or os.environ.get("DATABRICKS_HOST", "")
                default_token = config_values.get('databricks_token') or os.environ.get("DATABRICKS_TOKEN", "")
                default_catalog = config_values.get('catalog_name') or os.environ.get("DATABRICKS_CATALOG", "main")
